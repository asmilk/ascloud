...
public class IndexController {
	...
	public String index() {
		...
		//
		// boolean isContains =
		// this.accountCloudantRepository.contains(account.getId());
		...
		//
		// account = this.accountCloudantRepository.find(account.getId(), new
		// Params().rev(account.getRevision()));
		...
		//
		// LOG.info("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
		// queryResult = this.accountCloudantRepository.query(new
		// QueryBuilder(Expression.eq("name", "account1")).build());
